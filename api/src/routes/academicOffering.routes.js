  ...
  try {
    ...
    if (row.length > 0) {
      message(
        ...
        RESPONSE_MESSAGE.ACADEMIC_OFFERING_ALREADY_REGISTERED
      );
    } else {
      ...
      message(
        response,
        RESPONSE_CODE.OK,
        RESPONSE_MESSAGE.ACADEMIC_OFFERING_POST
      );
    }
  } catch (exception) {
    message(
    ...
    try {
      ...
      if (row.length > 0) {
        ...
        message(
          ...
          RESPONSE_MESSAGE.ACADEMIC_OFFERING_NOT_FOUND
        );
      }
    } catch (exception) {
      message(
