...
namespace ProfessorPerformanceEvaluation.Service
{
    public class EducationalExperienceService
    {
        ...
        public static async Task<Response> GetEducationalExperienceByName(EducationalExperience educationalExperience)
        {
            Response response = new Response();
            using (var httpClient = new HttpClient())
            {
                try
                {
                    ...
                    var httpRequestMessage = new HttpRequestMessage()
                    {
                        Content = new StringContent(JsonConvert.SerializeObject(educationalExperience), Encoding.UTF8, "application/json"),
                        Method = HttpMethod.Post,
                        RequestUri = new Uri(string.Concat(URL, "name"))
                    };
                    HttpResponseMessage httpResponseMessage = await httpClient.SendAsync(httpRequestMessage);
                    if (httpResponseMessage != null)
                    {
        ...
        public static async Task<Response> GetEducationalExperiencesByEducationalProgram(EducationalProgram educationalProgram)
        {
            Response response = new Response();
            using (var httpClient = new HttpClient())
            {
                try
                {
                    ...
                    var httpRequestMessage = new HttpRequestMessage()
                    {
                        ...
                        Method = HttpMethod.Post,
                        RequestUri = new Uri(string.Concat(URL, "educationalprogram"))
                    };
                    HttpResponseMessage httpResponseMessage = await httpClient.SendAsync(httpRequestMessage);
                    if (httpResponseMessage != null)
                    {
        ...
        public static async Task<Response> GetEducationalExperiencesByFaculty(Faculty faculty)
        {
            Response response = new Response();
            using (var httpClient = new HttpClient())
            {
        ...
        public static async Task<Response> GetEducationalExperienceByEducationalProgram(EducationalProgram educationalProgram)
        {
            Response response = new Response();
            using (var httpClient = new HttpClient())
            {
