...
public class ReviewService {
    ...
    public void getReviewsofStudent(Student student, ReviewServiceCallback callback) {
        Call<Response> call = ReviewClient.getInstance().getApiService().getReviewsOfStudent("Bearer " + token, student);
        call.enqueue(new Callback<Response>() {
            @Override
            public void onResponse(@NonNull Call<Response> call, @NonNull retrofit2.Response<Response> response) {
                if (response.isSuccessful()) {
